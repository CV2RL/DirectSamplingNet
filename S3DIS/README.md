...
CUDA_VISIBLE_DEVICES=1 python examples/segmentation/our_main.py --cfg cfgs/s3dis/pointnext-s.yaml 
CUDA_VISIBLE_DEVICES=2,1 python examples/segmentation/our_main.py --cfg /media/bigdata/Elements/BMVC2023/DGCNN/PointNeXt-master/cfgs/s3dis/pointnext-xl.yaml mode=test --pretrained_path log/s3dis/s3dis-train-pointnext-xl-ngpus2-seed21-20230504-164746-duNNGu6o5WhevfVhdzcnhy/checkpoint/s3dis-train-pointnext-xl-ngpus2-seed21-20230504-164746-duNNGu6o5WhevfVhdzcnhy_ckpt_best.pth

python examples/segmentation/main.py --cfg cfgs/s3dis/pointnext-xl.yaml
```
